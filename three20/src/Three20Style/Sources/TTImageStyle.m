...
- (void)draw:(TTStyleContext*)context {
  UIImage* image = [self imageForContext:context];
    isDrawBoundary = context.isDrawOuterBoundray;
    if (isDrawBoundary) {
        _contentMode = UIViewContentModeScaleAspectFit;
        //////
        //////   Added by Umar to aspect to fit thumbview
        //////
        CGSize imageSize = image.size;
        CGSize boxSize = context.contentFrame.size;
        if (imageSize.width < boxSize.width && imageSize.height < boxSize.height ) {
