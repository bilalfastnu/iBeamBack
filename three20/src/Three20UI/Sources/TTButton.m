...
///////////////////////////////////////////////////////////////////////////////////////////////////
- (BOOL)setIsDrawOuterBoundray:(BOOL)isDraw
{
    isDrawOuterBoundray = isDraw;
    return isDraw;
}
...
- (void)drawRect:(CGRect)rect {
  ...
  if (style) {
    ...
    context.isDrawOuterBoundray = isDrawOuterBoundray;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
-(void)setThumbImage:(UIImage*)p_image forState:(UIControlState)state
{
    TTButtonContent* content = [self contentForState:state];
    content.delegate = nil;
    content.imageURL = nil;
    content.image = p_image;
    [self setNeedsDisplay];
}
