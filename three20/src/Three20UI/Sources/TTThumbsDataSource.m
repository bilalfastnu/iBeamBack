...
//static CGFloat kThumbSize = 75 + 45;   //update column count too...
//static CGFloat kThumbSpacing = 4 + 36;
...
- (NSInteger)columnCountForView:(UIView *)view {
   /* CGFloat width = view.frame.size.width;
	NSInteger columnCountForOrientation;
	switch ([UIApplication sharedApplication].statusBarOrientation) {
		case UIInterfaceOrientationPortraitUpsideDown:
		case UIInterfaceOrientationPortrait:
			columnCountForOrientation = round((width - kThumbSpacing*2) / (kThumbSize+kThumbSpacing));
			break;
	...
	return 4;//round((width - kThumbSpacing*2) / (kThumbSize+kThumbSpacing));
}
