...
#define MG_DEFAULT_SPLIT_POSITION		250.0	// default width of master view in UISplitViewController.
...
- (void)layoutSubviewsForInterfaceOrientation:(UIInterfaceOrientation)theOrientation withAnimation:(BOOL)animate
{
	...
	CGRect newFrame = CGRectMake(0, MAIN_HEADER_VIEW_HEIGHT, width, height);
...
- (void)showMasterPopover:(id)sender
{
	if (_hiddenPopoverController && !(_hiddenPopoverController.popoverVisible)) {
		// Inform delegate.
